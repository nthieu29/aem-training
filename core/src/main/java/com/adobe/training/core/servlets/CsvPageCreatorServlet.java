...
@Slf4j
public class CsvPageCreatorServlet extends SlingAllMethodsServlet {
    @Reference
    ...
    protected void doPost(SlingHttpServletRequest request, SlingHttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            log.error("Failure to Read CSV: " + e);
        }
     ...
     */
    @SneakyThrows
    private JSONObject readCSV(InputStream stream) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if ((newPage.length > 1)
                    ...
                    try {
                        ...
                        log.error(path + " not created successfully: " + e);
                    }
